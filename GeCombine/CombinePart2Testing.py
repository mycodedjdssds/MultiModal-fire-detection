...
with open('options1.toml', 'r') as optionsFile:
...
class Net(nn.Module):
    ...
    def forward(self, x, y):
        x = self.pool11(F.relu(self.bn1(self.conv1(x))))
        #print("lalala",x)
